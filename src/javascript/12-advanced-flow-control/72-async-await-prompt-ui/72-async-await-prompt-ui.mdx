...
![what is your name diaglog box](./1076.png)
...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      <button class="askMe" data-question="What is your name?">
        Enter Name
      </button>
      <button class="askMe" data-cancel data-question="What is your age?">
        Enter Age
      </button>
    </div>
...
![calling ask function from console](./1077.png)
...
![adding required html code with form tag](./1078.png)
...
![define the popup class styles](./1079.png)
...
![making the does this work popup appear on the screen](./1080.png)
...
![opening different browser to see if it work there](./1081.png)
...
![does this work popup with an input and submit button](./1082.png)
...
![Uncaught (in promise) DOMException: Failed to execute 'appendChild' on 'Node'](./1083.png)

Why is that happening?

Let's debug by logging the value of `popup.firstChild` before we call `appendChild` on it.

![debug the logging value of popup.firstChild](./1084.png)
...
![code where fieldset is defined using backticks](./1085.png)

If you just modify the code so that the fieldset starts on the same line as the backtick, it will work.

![modify the fieldset starts on same line as the backtick](./1087.png)
...
![does this work diaglog box fixed](./1089.png)
...
![typing wes text in the input](./1090.png)
...
![form with popup and open class in console](./1092.png)
...
![call `ask({title:'does it work', cancel:true})` in console, typing the value and pressing submit, we see the promise in console with resolved value](./1094.png)
...
![use await in front of ask function to get the resolved value directly](./1095.png)
...
![pressing the submit button again wont do anything as no event listener is there](./1096.png)
...
![selecting the buttons using document.querySelectorAll](./1097.png)
...
![attaching the event listener to each of the button](./1098.png)
...
![button submitted click resulting in logging the typed value in console](./1099.png)

As you can see, when you click the popup for name and enter a name, we get the value back.

![adding data-cancel attribute to button](./1100.png)
...
![clicking age button logs `button.dataset` to console](./1101.png)
...
![instructions for `data-cancel` attribute](./1102.png)
...
![array of questions in code](./1103.png)
...
![questions asked in sequence in the html elements tab](./1104.png)
...
![array of 3 pending promises, which needs to be answered yet](./1105.png)
...
![script executed immediately without waiting for other question to resolve first](./1106.png)
...
![making async map function to make questions come up one after the another and submitted sequentially](./1107.png)
...
![clicking on submit will log the array in console](./1108.png)
